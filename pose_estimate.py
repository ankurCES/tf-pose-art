...
def process (input_image, params, model_params):
    ...
    for m in range(len(multiplier)):
        ...
        heatmap = np.squeeze(output_blobs[1])  # heatmaps
    ...
    idx_to_parts =  ["nose", "neck", "Rsho", "Relb", "Rwri", "Lsho", "Lelb", "Lwri", "Rhip", "Rkne", "Rank", "Lhip", "Lkne", "Lank", "Leye", "Reye", "Lear", "Rear", "pt19"]
...
while(cam.isOpened()) and ret_val == True and i < ending_frame:
    ...
    toc = time.time()
    canvas = cv2.resize(canvas, (500,500), fx=4, fy=4, interpolation=cv2.INTER_CUBIC)
